...
db("Plantillas").insertar("",[[
	...
	{"Beca":"select","name":"beca","value":0,"opcion":0,"opciones":"main"},
...
db("Estudiantes").insertar("Jesus Zerpa",[[
	{"Nombre":"titulo","name":"nombre","value":"Jesus Zerpa"},
	{"Nombres":"text","name":"nombres","value":"Jesus Abraham"},
	{"Apellidos":"text","name":"apellido","value":"Zerpa Maldonado"},
	{"Correo Electrónico":"email","name":"email","value":"jzerpa.occoa@gmail.com"},
